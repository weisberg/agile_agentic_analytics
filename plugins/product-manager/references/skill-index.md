...
- **prd-writer** (`name: prd-writer`) — Produces Product Requirements Documents, specs, product briefs, one-pagers, and PR/FAQs. Triggers: write a PRD, draft a spec, product doc, one-pager, PR/FAQ, feature brief, critique/level up a PRD. Does not trigger on engineering design docs, RFCs, or ADRs.
