...
version: "1.1.0"
description: >-
  Monitor early experiment health and temporal signal maturity: first-48-hours reads, sample-ratio-
  mismatch (SRM), exposure validation, operational guardrails, novelty and primacy effects, proxy
  signals, and early-versus-late evidence. Trigger when interpreting opening-day results. For the
  assignment or logging bug behind an SRM, use ab-testing review-experiment; for the final ship call,
  use experiment-decision-review.
triggers:
  - first 48 hours
  - early read
  - SRM
