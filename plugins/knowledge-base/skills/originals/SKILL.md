...
version: 0.1.0
description: >-
  Capture exact user phrasing, original ideas, theses, frameworks, strong reactions, and memorable language as first-class KB originals.
triggers:
  - "capture original"
  - "exact phrasing"
  - "save this thought"
...
- ORIGINAL CAPTURED
- Exact quote, context, page, related links, privacy scope.
